...
public class RoleMapper {
    ...
    public void insert(Role role) {
        ...
        try {
            statement = connection.prepareStatement("INSERT INTO roles VALUE(?)");
    ...
    public Role findById(Long id) throws SQLException, NotFoundException {
        PreparedStatement statement = connection.prepareStatement("SELECT id, name FROM roles WHERE id = ?");
        statement.setLong(1, id);
